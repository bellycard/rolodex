...
angular.module("rolodex").run(["$templateCache", function($templateCache) {$templateCache.put("rolodex_angular/template/accordion/accordion-group","<div class=\"panel panel-default\"><div class=\"panel-heading\"><h4 class=\"panel-title\"><a accordion-transclude=\"heading\" ng-click=\"toggleOpen()\" class=\"accordion-toggle\"><span ng-class=\"{\'text-muted\': isDisabled}\">{{heading}}</span></a></h4></div><div collapse=\"!isOpen\" class=\"panel-collapse\"><div class=\"panel-body\"></div></div></div>");
$templateCache.put("rolodex_angular/template/accordion/accordion","<div class=\"panel-group\"></div>");
$templateCache.put("rolodex_angular/template/alert/alert","<div ng-class=\"[\'alert-banner-\' + (type || \'warning\'), closeable ? \'alert-dismissable\' : null]\" role=\"alert\"><button ng-click=\"close()\" ng-show=\"closeable\" type=\"button\" aria-hidden=\"true\" class=\"i-close\">&times;</button><div></div></div>");
$templateCache.put("rolodex_angular/template/modal/window","<div ng-click=\"close($event)\" ng-class=\"{\'modal-fade\': animate}\" role=\"dialog\" tabindex=\"-1\" class=\"modal\"><div class=\"modal-content\"></div></div>");
...
$templateCache.put("rolodex_angular/template/datepicker/day","<table aria-activedescendant=\"{{ activeDateId }}\" aria-labelledby=\"{{uniqueId }}-title\" role=\"grid\"><thead><tr><th ng-click=\"move(-1)\" tabindex=\"-1\" class=\"prev available\"><div class=\"i-caret\"></div></th><th colspan=\"{{ 5 + showWeeks }}\" class=\"month\">{{ title }}</th><th ng-click=\"move(1)\" tabindex=\"-1\" class=\"next available\"><div class=\"i-caret\"></div></th></tr><tr><th ng-repeat=\"label in labels track by $index\" class=\"text-center\"><small aria-label=\"{{ label.full}}\">{{ label.abbr }}</small></th></tr></thead><tbody><tr ng-repeat=\"row in rows track by $index\"><td aria-disabled=\"{{ !!dt.disabled }}\" id=\"{{ dt.uid }}\" role=\"gridcell\" tabindex=\"-1\" ng-repeat=\"dt in row track by dt.date\" ng-class=\"{active: dt.selected, available: !dt.disabled, off: dt.disabled}\" ng-click=\"select(dt.date, dt.disabled)\" ng-disabled=\"dt.disabled\"><span ng-class=\"{\'text-muted\': dt.secondary}\">{{ dt.label }}</span></td></tr></tbody></table>");
$templateCache.put("rolodex_angular/template/datepicker/month","<table aria-activedescendant=\"{{ activeDateId }}\" aria-labelledby=\"{{ uniqueId }}-title\" role=\"grid\"><thead><tr><th><button ng-click=\"move(-1)\" tabindex=\"-1\" type=\"button\" class=\"btn btn-boring pull-left\"><i class=\"i-caret\"></i></button></th><th><button aria-atomic=\"true\" aria-live=\"assertive\" id=\"{{ uniqueId }}-title\" ng-click=\"toggleMode()\" role=\"heading\" style=\"width:100%;\" tabindex=\"-1\" type=\"button\" class=\"btn btn-boring\"><strong>{{ title }}</strong></button></th><th><button ng-click=\"move(1)\" tabindex=\"-1\" type=\"button\" class=\"btn btn-boring pull-right\"><i class=\"i-caret\"></i></button></th></tr></thead><tbody><tr ng-repeat=\"row in rows track by $index\"><td aria-disabled=\"{{ !!dt.disabled }}\" id=\"{{ dt.uid }}\" ng-repeat=\"dt in row track by dt.date\" role=\"gridcell\" class=\"text-center\"><button ng-class=\"{\'btn-info\': dt.selected, active: isActive(dt)}\" ng-click=\"select(dt.date)\" ng-disabled=\"dt.disabled\" style=\"width:100%;\" tabindex=\"-1\" type=\"button\" class=\"btn btn-boring\"><span ng-class=\"{\'text-info\': dt.current}\">{{ dt.label }}</span></button></td></tr></tbody></table>");
$templateCache.put("rolodex_angular/template/datepicker/popup","<div class=\"dropdown-menu daterangepicker date-picker-solo group\" ng-keydown=\"keydown($event)\"><div></div></div>");
$templateCache.put("rolodex_angular/template/datepicker/year","<table aria-activedescendant=\"{{ activeDateId }}\" aria-labelledby=\"{{ uniqueId }}-title\" role=\"grid\"><thead><tr><th><button ng-click=\"move(-1)\" tabindex=\"-1\" type=\"button\" class=\"btn btn-boring pull-left\"><i class=\"i-caret\"></i></button></th><th colspan=\"3\"><button aria-atomic=\"true\" aria-live=\"assertive\" id=\"{{ uniqueId }}-title\" ng-click=\"toggleMode()\" role=\"heading\" style=\"width:100%;\" tabindex=\"-1\" type=\"button\" class=\"btn btn-boring\"><strong>{{ title }}</strong></button></th><th><button ng-click=\"move(1)\" tabindex=\"-1\" type=\"button\" class=\"btn btn-boring pull-right\"><i class=\"i-caret\"></i></button></th></tr></thead><tbody><tr ng-repeat=\"row in rows track by $index\"><td aria-disabled=\"{{ !!dt.disabled }}\" id=\"{{ dt.uid }}\" ng-repeat=\"dt in row track by dt.date\" role=\"gridcell\" class=\"text-center\"><button ng-class=\"{\'btn-info\': dt.selected, active: isActive(dt)}\" ng-click=\"select(dt.date)\" ng-disabled=\"dt.disabled\" style=\"width:100%;\" tabindex=\"-1\" type=\"button\" class=\"btn btn-boring\"><span ng-class=\"{\'text-info\': dt.current}\">{{ dt.label }}</span></button></td></tr></tbody></table>");}]);
...
(function() {
  angular.module("rolodex.modal", ["rolodex.transition"]).factory("$$stackedMap", function() {
    return {
      createNew: function() {
        var stack;
        stack = [];
